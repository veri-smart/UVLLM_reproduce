...
module GF_matrix_ascending_binary_ref (
    clk,
    re,
    address_read,
    data_out
...
module input_syndromes_ref (
  ...
  GF_mult_add_syndromes_ref unit0_ref (
      .clk(clk),
      .reset(reset),
      .CE(CE_GF_mult_add),
      .ip1(ip1_0),
  ...
  GF_mult_add_syndromes_ref unit1_ref (
      .clk(clk),
      .reset(reset),
      .CE(CE_GF_mult_add),
      .ip1(ip1_1),
...
module RS_dec_ref (
  ...
  input_syndromes_ref input_syndromes_unit_ref (
      .clk(clk),
      .reset(reset),
      .CE(CE),
      .input_byte(input_byte),
  ...
  transport_in2out_ref transport_in2out_unit_ref (
  ...
  BM_lamda_ref BM_lamda_unit_ref (
      .clk  (clk),
      .reset(reset),
  ...
  lamda_roots_ref lamda_roots_unit_ref (
      .CE(L_ready),
      .clk(clk),
      .reset(reset),
  ...
  Omega_Phy_ref Omega_Phy_unit_ref (
      .clk  (clk),
      .reset(reset),
  ...
  error_correction_ref error_correction_unit_ref (
      .clk  (clk),
      .reset(reset),
  ...
  out_stage_ref out_stage_unit_ref (
      .clk  (clk),
      .reset(reset),
  ...
  GF_matrix_ascending_binary_ref power_rom_instant1_ref (
      .clk(clk),
      .re(1'b1),
  ...
  GF_matrix_ascending_binary_ref power_rom_instant2_ref (
      .clk(clk),
      .re(1'b1),
  ...
  GF_matrix_ascending_binary_ref power_rom_instant3_ref (
      .clk(clk),
      .re(1'b1),
  ...
  GF_matrix_ascending_binary_ref power_rom_instant4_ref (
      .clk(clk),
      .re(1'b1),
  ...
  GF_matrix_dec_ref rom_instant_1_ref (
      .clk(clk),
      .re(1'b1),
  ...
  GF_matrix_dec_ref rom_instant_2_ref (
      .clk(clk),
      .re(1'b1),
  ...
  GF_matrix_dec_ref rom_instant_3_ref (
      .clk(clk),
      .re(1'b1),
  ...
  GF_matrix_dec_ref rom_instant_4_ref (
      .clk(clk),
      .re(1'b1),
