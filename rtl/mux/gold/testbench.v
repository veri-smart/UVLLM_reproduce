...
module mux_4to1_case_tb();
    ...
    initial begin
        // tb1
        a = 4'd1; b = 4'd2; c = 4'd4; d = 4'd8;

        sel = 2'd0; #10; check_results();
        sel = 2'd1; #10; check_results();
        sel = 2'd2; #10; check_results();
        sel = 2'd3; #10; check_results();

        a = 4'd8; b = 4'd4; c = 4'd2; d = 4'd1;
